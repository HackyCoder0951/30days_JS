...
// Task 6 - User the `+=` operator to add number & log the result
...
// Task 7 - User the `-=` operator to add number & log the result
...
console.log("Activity 2 - Assignment Operators :- ");
// Task 1 - WAP to Compare two numbers using > and < & log the results
...
// Task 2 - WAP to Compare two numbers using >= and <= & log the results
...
// Task 3 - WAP to Compare two numbers using == and === & log the results
